...
from tkinter import Canvas, DoubleVar, Widget, mainloop, ttk
...
canvas.create_image(x0 -(l2+l3)*sin(angle)-l2*sin(angle2)+l*sin(angle), y0-254 + (l2+l3)*(1-cos(angle)) + l2*(1-cos(angle2)) - l*(1-cos(angle)), image=my_img3)
canvas.create_image(SolvesFirstAngle_X + SolvesSecondAngle_X + SolvesThirdAngle_X,SolvesFirstAngle_Y + SolvesSecondAngle_Y+SolvesThirdAngle_Y, image=my_img4)


lastAngle_X = 0
lastAnlge_Y = 0
canvas.create_image(SolvesFirstAngle_X + SolvesSecondAngle_X + SolvesThirdAngle_X + lastAngle_X,SolvesFirstAngle_Y + SolvesSecondAngle_Y+SolvesThirdAngle_Y-148+lastAnlge_Y, image=my_img5)
...
create_circle(x0, 250 + 70, 10, canvas) # Y = 320
# create_circle(x0, y0-254-120, 10, canvas)

create_circle(x0, y0-254-120-148+148/2, 10, canvas) # Y = 202
create_circle(x0, y0-254-120-148, 10, canvas) # Y = 128
