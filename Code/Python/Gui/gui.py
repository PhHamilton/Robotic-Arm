...
# create_circle(x0, 250 + 354, 10, canvas)
...
#         self.axis4Offset = -362 + self.armOffset_Y
#         self.endEffectorOffset = -510 + self.armOffset_Y #Might need adjustment!
...
#         self.endEffector = self.scaleImage(self.endEffector,5)
...
#         self.axis4 = Image.open('Images/Axis4.png')
#         self.endEffector = Image.open('Images/EndEffector.png')
...
#         elif axis == 4: 
#             return image.resize((round(self.scale*142),round(self.scale*156)))
#         elif axis == 5:
...
#         self.endEffectorTK = self.createTkImage(self.rotateImage(self.endEffector, Angle3))
#         self.createImage(self.x0 + self.armOffset_X -(self.l2+self.l3-self.l1)*self.sin(Angle1) -self.l5*self.sin(Angle2) -self.l4*self.sin(Angle3), self.y0 + self.endEffectorOffset, self.endEffectorTK)
